...
public class Level implements Serializable {
	...
	public Level(String name) {
		...
		else if (name.equals("Sample 2")) {
			map[0][0] = Terrain.road;
			map[1][0] = Terrain.road;
			map[2][0] = Terrain.road;
			map[3][0] = Terrain.road;
			map[4][0] = Terrain.road;
			map[1][1] = Terrain.road;
			map[1][2] = Terrain.road;
			map[1][3] = Terrain.road;
			map[2][3] = Terrain.road;
			map[2][4] = Terrain.road;
			map[2][5] = Terrain.road;
			map[2][6] = Terrain.road;
			map[2][7] = Terrain.road;
			map[3][7] = Terrain.road;
			map[4][7] = Terrain.road;
			map[5][7] = Terrain.road;
			map[6][7] = Terrain.road;
			map[7][7] = Terrain.road;
			map[8][7] = Terrain.road;
			map[9][7] = Terrain.road;
			map[10][7] = Terrain.road;
			map[10][8] = Terrain.road;
			map[10][9] = Terrain.road;
			map[10][10] = Terrain.road;
			map[10][11] = Terrain.road;
			map[10][12] = Terrain.road;
			map[10][13] = Terrain.road;
			map[10][14] = Terrain.road;
			map[10][15] = Terrain.road;
			map[11][16] = Terrain.road;
			map[11][17] = Terrain.road;
